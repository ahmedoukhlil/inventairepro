...
<head>
    ...
    <style>
        * {
        ...
        /* Améliorer le rendu SVG dans DomPDF */
        svg rect {
...
<body>
    <?php
        // Utiliser uniquement le SVG fourni côté client
        $barcodeData = $barcodeSvg ?? null;
    ?>
    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($barcodeData): ?>
            ...
            <div class="barcode-container">
                ...
                <?php elseif(isset($svgContent)): ?>
                    <?php
                        ...
                        // Supprimer les attributs width et height pour permettre le redimensionnement
                        $svgContent = preg_replace('/width="[^"]*"/', '', $svgContent);
                        $svgContent = preg_replace('/height="[^"]*"/', '', $svgContent);
                        
                        // Ajouter viewBox si absent pour permettre le redimensionnement
                        if (!preg_match('/viewBox=/', $svgContent)) {
                            // Extraire les dimensions du SVG si présentes
                            if (preg_match('/width="([^"]*)"/', $barcodeData, $widthMatch) && 
                                ...
                                // Valeurs par défaut pour Code 128
                                $svgContent = preg_replace('/<svg/', '<svg viewBox="0 0 200 40"', $svgContent, 1);
                            }
                        }
                        
                        // Ajouter preserveAspectRatio pour maintenir les proportions
                        ...
                        if (!str_contains($svgContent, 'style=')) {
                            ...
                            // Ajouter les styles si style existe déjà
                ...
                <?php else: ?>
                    <div style="text-align: center; color: #999; font-size: 12pt;">
    ...
    <?php else: ?>
        <div style="text-align: center; color: #999; font-size: 12pt; width: 100%; height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center;">
            <div>Code-barres non disponible</div>
            <div class="code-text" style="margin-top: 5mm;">
...
<?php /**PATH C:\xampp\htdocs\gesimmos\resources\views\pdf\etiquette-bien.blade.php ENDPATH**/ ?>