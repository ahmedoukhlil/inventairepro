...
[$__name, $__params] = $__split('components.searchable-select', ['name' => 'filter_designation','value' => (string) ($filterDesignation ?? ''),'options' => collect($designationOptions)->map(fn ($option) => [
                                ...
                                ])->toArray(),'placeholder' => 'Toutes les désignations','searchPlaceholder' => 'Rechercher une désignation...','noResultsText' => 'Aucune désignation trouvée','allowClear' => true]);

$key = 'corbeille-filter-designation-' . ($filterDesignation ?: 'all');

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-781575756-0', 'corbeille-filter-designation-' . ($filterDesignation ?: 'all'));
...
[$__name, $__params] = $__split('components.searchable-select', ['name' => 'filter_categorie','value' => (string) ($filterCategorie ?? ''),'options' => collect($categorieOptions)->map(fn ($option) => [
                                ...
                                ])->toArray(),'placeholder' => 'Toutes les catégories','searchPlaceholder' => 'Rechercher une catégorie...','noResultsText' => 'Aucune catégorie trouvée','allowClear' => true]);

$key = 'corbeille-filter-categorie-' . ($filterCategorie ?: 'all');

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-781575756-1', 'corbeille-filter-categorie-' . ($filterCategorie ?: 'all'));
...
[$__name, $__params] = $__split('components.searchable-select', ['name' => 'filter_emplacement','value' => (string) ($filterEmplacement ?? ''),'options' => collect($emplacementOptions)->map(fn ($option) => [
                                ...
                                ])->toArray(),'placeholder' => 'Tous les emplacements','searchPlaceholder' => 'Rechercher un emplacement...','noResultsText' => 'Aucun emplacement trouvé','allowClear' => true]);

$key = 'corbeille-filter-emplacement-' . ($filterEmplacement ?: 'all');

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-781575756-2', 'corbeille-filter-emplacement-' . ($filterEmplacement ?: 'all'));
...
[$__name, $__params] = $__split('components.searchable-select', ['name' => 'filter_etat','value' => (string) ($filterEtat ?? ''),'options' => collect($etatOptions)->map(fn ($option) => [
                                    ...
                                    'value' => '',
                                    'text' => 'Tous les états',
                                ])->toArray(),'placeholder' => 'Tous les états','searchPlaceholder' => 'Rechercher un état...','noResultsText' => 'Aucun état trouvé','allowClear' => true]);

$key = 'corbeille-filter-etat-' . ($filterEtat ?: 'all');

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-781575756-3', 'corbeille-filter-etat-' . ($filterEtat ?: 'all'));
...
[$__name, $__params] = $__split('components.searchable-select', ['name' => 'filter_natjur','value' => (string) ($filterNatJur ?? ''),'options' => collect($natJurOptions)->map(fn ($option) => [
                                ...
                                ])->toArray(),'placeholder' => 'Toutes les natures juridiques','searchPlaceholder' => 'Rechercher une nature juridique...','noResultsText' => 'Aucune nature juridique trouvée','allowClear' => true]);

$key = 'corbeille-filter-natjur-' . ($filterNatJur ?: 'all');

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-781575756-4', 'corbeille-filter-natjur-' . ($filterNatJur ?: 'all'));
...
[$__name, $__params] = $__split('components.searchable-select', ['name' => 'filter_sf','value' => (string) ($filterSF ?? ''),'options' => collect($sourceFinOptions)->map(fn ($option) => [
                                ...
                                ])->toArray(),'placeholder' => 'Toutes les sources','searchPlaceholder' => 'Rechercher une source de financement...','noResultsText' => 'Aucune source trouvée','allowClear' => true]);

$key = 'corbeille-filter-sf-' . ($filterSF ?: 'all');

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-781575756-5', 'corbeille-filter-sf-' . ($filterSF ?: 'all'));
