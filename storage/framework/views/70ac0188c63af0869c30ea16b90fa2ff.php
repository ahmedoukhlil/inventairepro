...
<div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
    <div>
        <h1 class="text-2xl font-bold tracking-tight text-slate-900"><?php echo e($title); ?></h1>
...
<?php /**PATH C:\xampp\htdocs\gesimmos\resources\views\components\page-header.blade.php ENDPATH**/ ?>