        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Produits</th>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="text-sm font-medium text-gray-900"><?php echo e($categorie->libelle); ?></div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-500">
                                <?php echo e($categorie->observations ? Str::limit($categorie->observations, 50) : '-'); ?>

                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="<?php echo e(route('stock.categories.edit', $categorie->id)); ?>" class="text-blue-600 hover:text-blue-900 mr-3">Modifier</a>
                            <button wire:click="confirmDelete(<?php echo e($categorie->id); ?>)" wire:loading.attr="disabled" wire:target="confirmDelete,delete" class="text-red-600 hover:text-red-900 disabled:opacity-50 disabled:cursor-not-allowed">Supprimer</button>
                        </td>
                    </tr>
