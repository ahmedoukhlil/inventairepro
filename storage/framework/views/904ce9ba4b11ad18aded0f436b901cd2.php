...
>
            ...
            <div class="flex items-center gap-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAdmin): ?>
                    ...
                    <?php elseif($inventaire->statut === 'en_cours'): ?>
                        <?php $nbRestantes = $this->localisationsNonTerminees; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nbRestantes === 0): ?>
                        ...
                        <?php else: ?>
                            <div class="flex items-center gap-2">
                                <button @click="open('terminer')" class="inline-flex items-center gap-2 px-4 py-2 bg-orange-600 text-white text-sm font-medium rounded-lg hover:bg-orange-700 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                    Terminer
                                    <span class="bg-orange-500 text-white text-xs rounded-full px-1.5 py-0.5 leading-none"><?php echo e($nbRestantes); ?></span>
                                </button>
                                <button @click="modals.forcer.message = 'ATTENTION : <?php echo e($nbRestantes); ?> localisation(s) non terminée(s). Tous les biens non scannés seront automatiquement marqués ABSENT. Cette action est irréversible.'; open('forcer')"
    ...
    <div
        ...
        x-data="{
            prev: { progression: <?php echo e($stats['progression_globale']); ?>, conformite: <?php echo e($stats['taux_conformite']); ?>, alertes: <?php echo e($this->totalAlertes); ?> },
        ...
        x-init="
            Livewire.on('statistiques-updated', () => {
                const progression = <?php echo e($stats['progression_globale']); ?>;
                const conformite = <?php echo e($stats['taux_conformite']); ?>;
                const alertes = <?php echo e($this->totalAlertes); ?>;
    ...
    >
        ...
        <div x-ref="cardAlertes" class="bg-white rounded-xl shadow-sm border <?php echo e($totalAlertes > 0 ? 'border-red-200' : 'border-gray-200'); ?> p-6 transition-shadow">
            <div class="flex items-center justify-between mb-4">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->derniersScans->count() > 0): ?>
        ...
        <div
            ...
            x-data="{
                knownIds: <?php echo \Illuminate\Support\Js::from($this->derniersScans->pluck('id')->toArray())->toHtml() ?>,
                flashNew() {
                    this.$nextTick(() => {
        ...
        >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->derniersScans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <div data-scan-id="<?php echo e($scan->id); ?>" wire:key="scan-<?php echo e($scan->id); ?>" class="rounded-lg border <?php echo e($scanColors[$scan->statut_scan] ?? 'border-gray-200 bg-gray-50'); ?> p-3">
                        <div class="flex items-center justify-between gap-2 mb-1">
                            ...
                            <span class="text-[10px] uppercase font-semibold text-gray-500 tracking-wide"><?php echo e($statutLabels[$scan->statut_scan] ?? $scan->statut_scan); ?></span>
                        </div>
                        <p class="text-xs text-gray-500 truncate mb-1" title="<?php echo e($scan->designation); ?>"><?php echo e($scan->designation); ?></p>
                        <div class="flex items-center justify-between text-xs text-gray-400">
                            <span class="truncate"><?php echo e($scan->agent?->users ?? $scan->agent?->name ?? 'Système'); ?></span>
                            <span class="flex-shrink-0 ml-1"><?php echo e($scan->date_scan?->diffForHumans(['short' => true])); ?></span>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
