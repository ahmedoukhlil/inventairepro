<div>
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900">
            <?php echo e($this->isEdit && $this->localisation ? 'Modifier ' . $this->localisation->Localisation : 'Ajouter une localisation'); ?>

        </h1>
        <p class="mt-1 text-sm text-gray-500">
            <?php echo e($this->isEdit ? 'Modifiez les informations de la localisation' : 'Remplissez le formulaire pour ajouter une nouvelle localisation'); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm <?php $__errorArgs = ['Localisation'];
                        ...
                        <div class="flex gap-2">
                            <div class="flex-1 relative">
                                ...
                                <input 
                                    ...
                                    class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm <?php $__errorArgs = ['CodeLocalisation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['CodeLocalisation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\xampp\htdocs\gesimmos\resources\views\livewire\localisations\form-localisation.blade.php ENDPATH**/ ?>