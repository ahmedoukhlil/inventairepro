...
<body class="font-sans antialiased bg-gray-50">
            ...
            <nav class="sidebar-scroll-hide flex-1 overflow-y-auto py-4 px-3">
                <ul class="space-y-1">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->canManageInventaire()): ?>
                            ...
                            <li>
                                <a href="<?php echo e(route('localisations.index')); ?>" 
                                   class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-colors <?php echo e(request()->routeIs('localisations.*') ? 'bg-gray-700 text-white' : ''); ?>">
                                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <li>
                                <a href="<?php echo e(route('emplacements.index')); ?>" 
                                   class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-colors <?php echo e(request()->routeIs('emplacements.*') ? 'bg-gray-700 text-white' : ''); ?>">
                                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    </svg>
                            ...
                            <li>
                                <a href="<?php echo e(route('affectations.index')); ?>" 
                                   class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-colors <?php echo e(request()->routeIs('affectations.*') ? 'bg-gray-700 text-white' : ''); ?>">
                                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <li>
                                <a href="<?php echo e(route('biens.index')); ?>" 
                                   class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-colors <?php echo e(request()->routeIs('biens.index') || request()->routeIs('biens.show') ? 'bg-gray-700 text-white' : ''); ?>">
                                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <li>
                                <a href="<?php echo e(route('biens.create')); ?>" 
                                   class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-colors <?php echo e(request()->routeIs('biens.create') || request()->routeIs('biens.edit') ? 'bg-gray-700 text-white' : ''); ?>">
                                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Collecte initiale -->
                        <li>
                            <a href="<?php echo e(route('collecte-initiale.index')); ?>"
                               class="flex items-center px-4 py-3 text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-colors <?php echo e(request()->routeIs('collecte-initiale.*') ? 'bg-gray-700 text-white' : ''); ?>">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <nav class="hidden md:flex items-center space-x-2 text-sm text-gray-500">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($breadcrumbs)): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breadcrumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span>/</span>
                                <a href="<?php echo e($breadcrumb['url'] ?? '#'); ?>" class="hover:text-gray-700"><?php echo e($breadcrumb['label']); ?></a>
                            ...
                            >
                                <div class="flex items-center space-x-2">
                                    <div class="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white font-semibold">
                                        <?php echo e(strtoupper(substr(auth()->user()->users ?? auth()->user()->name ?? 'U', 0, 1))); ?>

                                    </div>
                                    <div class="hidden md:block text-left">
                                        <div class="text-sm font-medium text-gray-900"><?php echo e(auth()->user()->users ?? auth()->user()->name ?? 'Utilisateur'); ?></div>
                                        <div class="text-xs text-gray-500">
                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium <?php echo e(auth()->user()->isAdmin() ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800'); ?>">
    ...
    <script>
        ...
        ?>
        var sessionMessages = {
            success: <?php echo json_encode($success ?? null, 15, 512) ?>,
            error: <?php echo json_encode($error ?? null, 15, 512) ?>,
            info: <?php echo json_encode($info ?? null, 15, 512) ?>,
            warning: <?php echo json_encode($warning ?? null, 15, 512) ?>
        };
...
<?php /**PATH C:\xampp\htdocs\gesimmos\resources\views\layouts\app.blade.php ENDPATH**/ ?>