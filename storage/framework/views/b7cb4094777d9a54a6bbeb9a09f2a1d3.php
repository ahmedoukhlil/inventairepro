...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2803339623-0', 'localisation-select-transfer');
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2803339623-1', 'affectation-select-transfer-' . ($idLocalisation ?? 'none'));
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2803339623-2', 'emplacement-select-transfer-' . ($idLocalisation ?? 'none') . '-' . ($idAffectation ?? 'none'));
...
<?php /**PATH C:\xampp\htdocs\gesimmos\resources\views\livewire\biens\transfert-bien.blade.php ENDPATH**/ ?>