<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
        ...
        <a href="<?php echo e(route('stock.magasins.create')); ?>"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $magasins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $magasin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-sm font-semibold text-gray-800"><?php echo e($magasin->magasin); ?></span>
                                </div>
                            </td>
                            <td class="px-4 py-3 hidden sm:table-cell">
                                <div class="flex items-center gap-1.5 text-sm text-gray-600">
                                    ...
                                    <?php echo e($magasin->localisation ?: '—'); ?>

                                </div>
                            </td>
                            <td class="px-4 py-3 text-center">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold
                                    <?php echo e($magasin->produits_count > 0 ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-500'); ?>">
                                    <?php echo e($magasin->produits_count); ?>

                                </span>
                            </td>
                            <td class="px-4 py-3 hidden lg:table-cell">
                                <p class="text-sm text-gray-500 truncate max-w-[220px]">
                                    <?php echo e($magasin->observations ? Str::limit($magasin->observations, 55) : '—'); ?>

                                </p>
                            </td>
                            <td class="px-6 py-3 text-right whitespace-nowrap">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="<?php echo e(route('stock.magasins.edit', $magasin->id)); ?>"
                                    ...
                                    <button wire:click="confirmDelete(<?php echo e($magasin->id); ?>)"
                                            wire:loading.attr="disabled"
                                            ...
                                            class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-medium transition-colors disabled:opacity-40
                                                   <?php echo e($magasin->produits_count > 0
                                                        ? 'bg-gray-100 text-gray-400 cursor-not-allowed pointer-events-none'
                                                        : 'bg-red-50 text-red-600 hover:bg-red-100'); ?>"
                                            <?php if($magasin->produits_count > 0): ?> title="Impossible : contient <?php echo e($magasin->produits_count); ?> produit(s)" <?php endif; ?>>
                                        <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($magasins->hasPages()): ?>
            <div class="px-6 py-4 border-t border-gray-100 flex items-center justify-between gap-4">
                <p class="text-xs text-gray-500">
                    <?php echo e($magasins->firstItem()); ?>–<?php echo e($magasins->lastItem()); ?> sur <?php echo e($magasins->total()); ?> magasin<?php echo e($magasins->total() > 1 ? 's' : ''); ?>
        ...
        <?php else: ?>
            <div class="px-6 py-3 border-t border-gray-50">
                <p class="text-xs text-gray-400"><?php echo e($magasins->total()); ?> magasin<?php echo e($magasins->total() > 1 ? 's' : ''); ?></p>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\gesimmos\resources\views/livewire/stock/magasins/liste-magasins.blade.php ENDPATH**/ ?>