                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="text-sm font-medium text-gray-900">
                                    <?php echo e($magasin->magasin); ?>

                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900"><?php echo e($magasin->localisation); ?></div>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-500">
                                <?php echo e($magasin->observations ? Str::limit($magasin->observations, 50) : '-'); ?>
                        ...
                        <td colspan="5" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search): ?>
                                    <p class="text-xs text-gray-400 mt-1">Essayez une autre recherche</p>
                                <?php else: ?>
                                    <p class="text-xs text-gray-400 mt-1">Commencez par créer votre premier magasin</p>
