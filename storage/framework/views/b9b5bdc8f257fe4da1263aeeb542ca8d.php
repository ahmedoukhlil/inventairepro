<div>
    ...
    <div class="mb-6">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="<?php echo e(route('affectations.index')); ?>" class="ml-1 text-sm font-medium text-gray-700 hover:text-indigo-600 md:ml-2">Affectations</a>
                    </div>
                </li>
        ...
        <h1 class="text-3xl font-bold text-gray-900">
            <?php echo e($this->isEdit && $this->affectation ? 'Modifier ' . $this->affectation->Affectation : 'Ajouter une affectation'); ?>

        </h1>
        <p class="mt-1 text-sm text-gray-500">
            <?php echo e($this->isEdit ? 'Modifiez les informations de l\'affectation' : 'Remplissez le formulaire pour ajouter une nouvelle affectation'); ?>
...
[$__name, $__params] = $__split('components.searchable-select', ['wire:model' => 'idLocalisation','options' => $this->localisationOptions,'placeholder' => 'Sélectionner une localisation','searchPlaceholder' => 'Rechercher une localisation...','noResultsText' => 'Aucune localisation trouvée','allowClear' => true,'name' => 'idLocalisation']);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1223353239-0', null);
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm <?php $__errorArgs = ['Affectation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['Affectation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\xampp\htdocs\gesimmos\resources\views/livewire/affectations/form-affectation.blade.php ENDPATH**/ ?>