        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    <?php echo e($totalDesignations); ?> désignation(s)
                </p>
            </div>
            
            <div class="flex flex-wrap items-center gap-2">
                <a 
                    href="<?php echo e(route('designations.create')); ?>"
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <div class="mt-3">
                    <textarea
                        ...
                        class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
                </div>
                ...
                <div class="mt-3 flex justify-end">
                    <button
                        ...
                        Envoyer les immobilisations en corbeille
                    </button>
                </div>
            </div>
            ...
            <div 
                    ...
                    <div>
                        ...
                        <select 
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($categorie->idCategorie); ?>"><?php echo e($categorie->Categorie); ?></option>
                ...
                <div class="mt-4 flex items-center justify-between">
                    ...
                    <div class="text-sm text-gray-600">
                        <span class="font-medium"><?php echo e($designations->total()); ?></span> désignation(s) trouvée(s)
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" wire:click="sortBy('designation')">
                                <div class="flex items-center">
                                    Désignation
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortField === 'designation'): ?>
                            ...
                            <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" wire:click="sortBy('categorie')">
                                <div class="flex items-center">
                                    Catégorie
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortField === 'categorie'): ?>
                                        <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($sortDirection === 'asc' ? 'M5 15l7-7 7 7' : 'M19 9l-7 7-7-7'); ?>" />
                                        </svg>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($designation->designation); ?></div>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="text-sm text-gray-900"><?php echo e($designation->CodeDesignation ?? '-'); ?></div>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($designation->categorie): ?>
                                            <?php echo e($designation->categorie->Categorie); ?>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">
                                        <?php echo e($designation->immobilisations_count); ?>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAdmin): ?>
                                            <a 
                                                href="<?php echo e(route('designations.edit', $designation)); ?>"
                                                class="text-yellow-600 hover:text-yellow-900 transition-colors"
                                                aria-label="Modifier la désignation <?php echo e($designation->designation); ?>"
                                                title="Modifier">
                                            ...
                                            <button 
                                                wire:click="deleteDesignation(<?php echo e($designation->id); ?>)"
                                                wire:confirm="Supprimer la désignation '<?php echo e($designation->designation); ?>' ? <?php echo e($designation->immobilisations_count); ?> immobilisation(s) liee(s) seront placees dans la corbeille."
                                                class="text-red-600 hover:text-red-900 transition-colors"
                                                aria-label="Supprimer la désignation <?php echo e($designation->designation); ?>"
                                                title="Supprimer">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="5" class="px-4 py-12 text-center">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $filterCategorie): ?>
...
<?php /**PATH C:\xampp\htdocs\gesimmos\resources\views/livewire/designations/liste-designations.blade.php ENDPATH**/ ?>