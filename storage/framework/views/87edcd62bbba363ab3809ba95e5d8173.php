...
<nav
    ...
    x-data="{
        open: '<?php echo e($defaultMenu); ?>',
        openImmoSub: <?php echo e($openImmoSettings ? 'true' : 'false'); ?>,
        openStockSub: <?php echo e($openStockSettings ? 'true' : 'false'); ?>,
        toggle(key) {
        ...
        init() {
            ...
            if ('<?php echo e($defaultMenu); ?>' !== '') return;
...
>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canManageInventaire): ?>

        
        <div>
            <button @click="toggle('immos')" type="button"
                class="nav-item w-full <?php echo e($defaultMenu === 'immos' ? 'nav-active' : 'nav-inactive'); ?>"
            ...
            <div x-show="open === 'immos'" x-transition x-cloak class="mt-0.5 ml-3 space-y-0.5 border-l border-slate-700/50 pl-3">
                ...
                <?php $a = request()->routeIs('biens.index', 'biens.show'); ?>
                <a wire:navigate href="<?php echo e(route('biens.index')); ?>" class="nav-sub <?php echo e($a ? 'nav-sub-active' : ''); ?>" <?php if($a): ?> aria-current="page" <?php endif; ?>>
                ...
                <?php $a = request()->routeIs('biens.create', 'biens.edit'); ?>
                <a wire:navigate href="<?php echo e(route('biens.create')); ?>" class="nav-sub <?php echo e($a ? 'nav-sub-active' : ''); ?>" <?php if($a): ?> aria-current="page" <?php endif; ?>>
                ...
                <?php $a = request()->routeIs('biens.transfert'); ?>
                <a wire:navigate href="<?php echo e(route('biens.transfert')); ?>" class="nav-sub <?php echo e($a ? 'nav-sub-active' : ''); ?>" <?php if($a): ?> aria-current="page" <?php endif; ?>>
                ...
                <?php $a = request()->routeIs('biens.transfert.historique'); ?>
                <a wire:navigate href="<?php echo e(route('biens.transfert.historique')); ?>" class="nav-sub <?php echo e($a ? 'nav-sub-active' : ''); ?>" <?php if($a): ?> aria-current="page" <?php endif; ?>>
                ...
                <?php $a = request()->routeIs('corbeille.immobilisations.*'); ?>
                <a wire:navigate href="<?php echo e(route('corbeille.immobilisations.index')); ?>" class="nav-sub <?php echo e($a ? 'nav-sub-active' : ''); ?>" <?php if($a): ?> aria-current="page" <?php endif; ?>>
                ...
                <div class="pt-2">
                    ...
                    <div x-show="openImmoSub" x-transition class="mt-0.5 space-y-0.5">
                        ...
                        <?php $a = request()->routeIs($item['patterns']); ?>
                        <a wire:navigate href="<?php echo e(route($item['route'])); ?>" class="nav-sub <?php echo e($a ? 'nav-sub-active' : ''); ?>" <?php if($a): ?> aria-current="page" <?php endif; ?>>
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="<?php echo e($item['icon']); ?>"/></svg>
        ...
        <?php $active = request()->routeIs('inventaires.*'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canAccessStock): ?>
        ...
        <div x-show="open === 'stock'" x-transition x-cloak class="mt-0.5 ml-3 space-y-0.5 border-l border-slate-700/50 pl-3">
            ...
            <a wire:navigate href="<?php echo e(route('stock.produits.index')); ?>" class="nav-sub <?php echo e($a ? 'nav-sub-active' : ''); ?>" <?php if($a): ?> aria-current="page" <?php endif; ?>>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canCreateEntree): ?>
            <?php $a = request()->routeIs('stock.entrees.*'); ?>
            <a wire:navigate href="<?php echo e(route('stock.entrees.index')); ?>" class="nav-sub <?php echo e($a ? 'nav-sub-active' : ''); ?>" <?php if($a): ?> aria-current="page" <?php endif; ?>>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canCreateSortie): ?>
            <?php $a = request()->routeIs('stock.sorties.*'); ?>
            <a wire:navigate href="<?php echo e(route('stock.sorties.index')); ?>" class="nav-sub <?php echo e($a ? 'nav-sub-active' : ''); ?>" <?php if($a): ?> aria-current="page" <?php endif; ?>>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canManageStock): ?>
            <div class="pt-2">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAdmin): ?>
        ...
        <a wire:navigate href="<?php echo e(route('users.index')); ?>"
           class="nav-item <?php echo e($active ? 'nav-active' : 'nav-inactive'); ?>"
           <?php if($active): ?> aria-current="page" <?php endif; ?>>
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
<?php /**PATH C:\xampp\htdocs\gesimmos\resources\views/components/layouts/sidebar-menu.blade.php ENDPATH**/ ?>