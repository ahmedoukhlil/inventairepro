...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::transaction(function () use ($designationIds): void {
            $now = now();

            $numOrdres = DB::table('gesimmo as g')
            ...
            if ($numOrdres->isEmpty()) {
                return;
            }

            $numOrdres->chunk(500)->each(function ($chunk) use ($now): void {
                $numOrdresChunk = $chunk->values()->all();
                ...
                foreach ($rows as $row) {
                    ...
                    $toInsert[] = [
                        ...
                        'deleted_reason' => 'Suppression par designation (migration)',
    ...
    public function down(): void
    {
        ...
        // restaurer depuis backup si necessaire.
    }
};
