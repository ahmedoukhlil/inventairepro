<div>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="text-sm font-medium text-gray-900">{{ $demandeur->nom }}</div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-700">{{ $demandeur->poste_service }}</div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('stock.demandeurs.edit', $demandeur->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">Modifier</a>
                            <button wire:click="confirmDelete({{ $demandeur->id }})" wire:loading.attr="disabled" wire:target="confirmDelete,delete" class="text-red-600 hover:text-red-900 disabled:opacity-50 disabled:cursor-not-allowed">Supprimer</button>
                        </td>
                    </tr>
                @empty
                    <tr>
    ...
    <div class="mt-6">{{ $demandeurs->links() }}</div>
