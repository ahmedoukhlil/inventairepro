                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        <a 
                                            ...
                                            aria-label="Voir le bien {{ $bien->NumOrdre }}"
                                            title="Voir">
                                        ...
                                        @if($isAdmin)
                                            <a 
                                                ...
                                                aria-label="Modifier le bien {{ $bien->NumOrdre }}"
                                                title="Modifier">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <a 
                                            ...
                                            aria-label="Afficher le code-barres du bien {{ $bien->NumOrdre }}"
                                            title="Code-barres">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        @if($isAdmin)
                                            <button 
                                                ...
                                                aria-label="Supprimer le bien {{ $bien->NumOrdre }}"
                                                title="Supprimer">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
