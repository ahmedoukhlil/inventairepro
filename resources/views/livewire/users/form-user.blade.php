                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="nom_complet" class="block text-sm font-medium text-gray-700 mb-1">
                                Nom complet
                                <span class="text-gray-400 text-xs font-normal">(affiché dans l'app)</span>
                            </label>
                            <input
                                type="text"
                                id="nom_complet"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('poste') border-red-300 @enderror"
                                wire:loading.attr="disabled">
                            @error('poste')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
