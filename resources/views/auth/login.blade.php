<x-guest-layout>
    <x-slot name="logo">
        <div class="flex flex-col items-center gap-3">
            <img src="{{ asset('images/Image1.jpg') }}" alt="Logo" class="h-24 w-auto object-contain">
        </div>
    </x-slot>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input
                    ...
                    class="block w-full rounded-lg border border-white/10 bg-white/5 py-2.5 pl-10 pr-4 text-sm text-white placeholder-slate-500 outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 @error('users') border-red-500/50 @enderror">
            </div>
        </div>
